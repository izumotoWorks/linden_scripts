...
// 透過させたいOBJがレシーバーとなる
// 
// １．さっき送ったオブジェクトをHUDに装着
// ２．HUDから透過させたいオブジェクトに新しくスクリプトを作成する
// ３．以下のURLにアクセスしてコードをコピーする
// 
// https://github.com/izumotoWorks/linden_scripts/blob/main/example/HUD/obj_alpha_slider_receiver.lsl
// 
// ４．コードの36行目のチャネルを任意の値に変更(誰ともかぶらなければ変更しなくてOK)
// ５．対象が単プリムの場合はコード17行目の値を -1 から 1 に変更
// ６．保存して適用
// ７．HUD側でスライダーをいじればその数値が指定のチャネルに飛んで値を透過度に適用する
// 
// 【面選択について】
// 
// 面選択は作成中
// 
// ダイアログで面選択して全部か１つずつかを選べるようにする予定
// １つの面だけ指定はおそらく簡単
// ２つとか３つとか複数の面を選択する場合はちょっと考える必要あり
// 
// どういう選び方ができたらいい感じになるか教えてください
// 
// よくわからん部分とかバグあったらスクショ取ってもらえると助かる！